/**
 * @class
 * @name dom.expand.RefineryWallpaper
 * @description Functionality for a RefineryWallpaper for a site.
 * @example var wp = new RefineryWallpaper({
 *     stage: stage,
 *     path: 'img/RefineryWallpaper1.jpg',
 *     color: '#000000',
 *     onClick: function(){
 *        console.log('RefineryWallpaper clicked, should clickthrough!');
 *     },
 * });
 ...
 * @property {Boolean} fixed - Is the RefineryWallpaper fixed or is it possible to scroll past it? 
 * @property {Boolean} repeatX - Repeat the RefineryWallpaper horizontally? 
 * @property {Boolean} repeatY - Repeat the RefineryWallpaper vertiaclly? 
 * @property {String} color - Background color. 
 * @property {Boolean} clickable - Is the RefineryWallpaper clickable? 
...
define([
    ...
    var RefineryWallpaper = function(options){
        
        var self = this;

        // Original values of the body when the RefineryWallpaper is disabled.
        var disabledValues = {};

        // Values of the body and other elements when the RefineryWallpaper is enabled.
        var enabledValues = {};
        ...
        /**
         * @function
         * @name dom.expand.RefineryWallpaper#addValue
         * @description 
         * @param name
         * @param value
         * @param style
        ...
        /**
         * @function
         * @name dom.expand.RefineryWallpaper#setStaticBackground
         * @description 
         * @private
         */
        ...
        /**
         * @function
         * @name dom.expand.RefineryWallpaper#getClickAreaWidth
        ...
        /**
         * @function
         * @name dom.expand.RefineryWallpaper#getSidebarOptions
         * @description 
         * @param target
         * @param width
         * @param height
        ...
        /**
         * @function
         * @name dom.expand.RefineryWallpaper#createSidebars
         * @description 
         * @private
         */
        ...
        /**
         * @function
         * @name dom.expand.RefineryWallpaper#resizeClickArea
         * @description 
         * @param screenSize
         * @private
         */
        ...
        /**
         * @function
         * @name dom.expand.RefineryWallpaper#onload
         * @description 
         * @param loadInfo
         * @private
         */
        ...
        /**
         * @function
         * @name dom.expand.RefineryWallpaper#disable
        ...
        /**
         * @function
         * @name dom.expand.RefineryWallpaper#enable
         * @description 
         * @public
         */
        ...
        /**
         * @function
         * @name dom.expand.RefineryWallpaper#remove
         * @description 
         * @public
         */
